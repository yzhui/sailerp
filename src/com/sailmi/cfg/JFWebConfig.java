...
import com.sailmi.erp.model.sso.Position;
import com.sailmi.handler.ServletHandler;
import com.sailmi.interceptor.PermissionInterceptor;
import com.sailmi.jfinal.plugin.AutoTableBindPlugin;
import com.sailmi.jfinal.plugin.MyRoutesUtil;
import com.sailmi.jfinal.plugin.TableNameStyle;
import com.sailmi.jfinal.plugin.activerecord.dialect.MyPostgreSqlDialect;
import com.sailmi.jfinal.plugin.quartz.QuartzPlugin;
import com.sailmi.kit.I18N;
import com.sailmi.util.PropertiesContent;
/**
 * API引导式配置
 * @author joffee 歌樵
 *2013-6-5
