package com.sailmi.erp.ctrl.sale;
...
import com.sailmi.erp.model.sale.Genjinfankui;
...
*
*/
@RouteBind(path = "genjinfankui")
public class GenjinfankuiCtrl extends AdminBaseController<Genjinfankui> {
	public GenjinfankuiCtrl() {
		this.tableName = Genjinfankui.tableName;
		modelClass = Genjinfankui.class;
	}
	public void index(){
	...
	public void dataGrid() {
		...
		Page<Record> p = Db.paginate(this.getParaToInt("page", 1), this.getParaToInt("rows", 20), "select t.ID,t.GJID, 1 ", "from " + this.tableName+ " t where 1=1 " + where.toString(), param.toArray());
