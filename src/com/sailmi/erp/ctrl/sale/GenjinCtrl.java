...
import com.sailmi.erp.model.sale.Genjin;
...
*
*/
@RouteBind(path = "genjin")
public class GenjinCtrl extends AdminBaseController<Genjin> {
	public GenjinCtrl() {
		this.tableName = Genjin.tableName;
		modelClass = Genjin.class;
	}
	public void index(){
	...
	public void dataGrid() {
		...
		Page<Record> p = Db.paginate(this.getParaToInt("page", 1), this.getParaToInt("rows", 20), "select t.ID,t.CUSTID,t.CONTACTID,t.LIANXIFANGSHI,t.LXDATE, 1 ", "from " + this.tableName+ " t where 1=1 " + where.toString(), param.toArray());
