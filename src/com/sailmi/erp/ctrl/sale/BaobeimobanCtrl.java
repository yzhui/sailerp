...
import com.sailmi.erp.model.sale.Baobeimoban;
...
*SaleBaobeimoban
*/
@RouteBind(path = "baobeimoban")
public class BaobeimobanCtrl extends AdminBaseController<Baobeimoban> {
	public BaobeimobanCtrl() {
		this.tableName = Baobeimoban.tableName;
		modelClass = Baobeimoban.class;
	}
	public void dataGrid() {
		...
		Page<Record> p = Db.paginate(this.getParaToInt("page", 1), this.getParaToInt("rows", 20), "select t.ID,t.CNAME, 1 ", "from " + this.tableName+ " t where 1=1 " + where.toString(), param.toArray());
