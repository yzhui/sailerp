...
import com.sailmi.erp.model.oa.Recvmsg;
...
*
*/
@RouteBind(path = "recvmsg")
public class RecvmsgCtrl extends AdminBaseController<Recvmsg> {
	public RecvmsgCtrl() {
		this.tableName = Recvmsg.tableName;
		modelClass = Recvmsg.class;
	}
