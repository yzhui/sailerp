...
public class CustMemorialday extends Model<CustMemorialday> {
	private static final long serialVersionUID = 8699093530520166772L;
	public static final String tableName="crm_customer_cares";
	public static CustMemorialday dao=new CustMemorialday();
	public Page<CustMemorialday> page(int pageNo, int pageSize, Map<String, Object> filter,Integer qryType) {
	...
	public CustMemorialday findById(String id,String company_id){
		String userView=Person.tableName;
